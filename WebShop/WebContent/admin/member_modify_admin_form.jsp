		...
		<form name="modifyFormAdmin" method="post" action=member_modify_admin_action.jsp>
			<table border="1">
				<tr align="center" style="background-color: #8899aa">
					<td colspan="2"><b style="color: #FFFFFF"><%=dto.getName() %>'s info is edited by (Administrator)</b></td>
				</tr>
				<tr>
					<td width="16%">ID</td>
					<td width="57%">
				...
				<tr>
					...
					<td>
						<select name="job" onselect="기타" onshow="기타" >
							...
							<option value="기타">else
						</select>
					</td>
				</tr>
				<tr>
					<td colspan="2" align="center">
						<input type="button" value="Complete Editing" id="btnModify" />
						&nbsp;&nbsp;
						<input type="button" value="Cancel Editing" id="btnModifyCancel" />
						<input type="button" value="Delete this member" id="btnDelete" />
					</td>
				</tr>
			</table>
		</form>
