	...
	<form action="cartprocess.jsp" method="get">
		<table style="width:80%;">
			<tr style="background-color: gold">
				<th>Order</th><th>가격</th><th>수량</th><th>수정/삭제</th><th>조회</th>
			</tr>
		<%
			int totalPrice = 0;
			...
			if(hCart.size()==0){
		%>
			<tr><td>No Order in the list</td></tr>
		<% 
			//장바구니에 내용이 있을경우
			} else { 
				//카트의 모든 제품코드(키값)을 추출
		...
		%>		
				...
				<tr style="text-align: center;">
					...
					<td> 
						...
						<!-- 수정/삭제 버튼 -->
						<input type="button" value="EDIT" onclick="cartUpdate(this.form)" style="background-color: silver"> /
						<input type="button" value="DELETE" onclick="cartDelete(this.form)" style="background-color: silver"> 
					</td>
					<td><a href="javascript:productDetail('<%=product.getNo()%>')">Detail</a></td>
				</tr>
		<%
				}
		%>
			<tr>
				<td colspan="5">
					...
					&nbsp;&nbsp;&nbsp;
					<a href="orderprocess.jsp">[ Order ]</a>
				</td>
			</tr>
		<%	
			}
